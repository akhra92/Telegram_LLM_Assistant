...
- Powered by Qwen 3.5 (7B) running locally via Ollama — no API key required
...
> Qwen 3.5 7B is ~4.7 GB. For a lighter option use `qwen3.5:3b`; for better quality use `qwen3.5:14b`. Change the model name in `llm.py` if needed.
